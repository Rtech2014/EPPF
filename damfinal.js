...
function pred(){
    ...
    predctn=(rainwater+waterflow)*120;
    ...
    {
                dischargewater=predctncff-threshold2;
        ...
        {
                testObjecttv2.save({ token:"2",tokenvalue:dischargewater }).then(function(object) {
      ...
      var query1 = new Parse.Query(testObjecttv1);
      ...
      success: function(testObjecttv1) {
              ...
              var post = testObjecttv1[0].get("token");
              var post1 = testObjecttv1[0].get("value");
              var tkn  = post;
              var tknvl = post1;
              console.log("frkhjhymtg");
              console.log("tekken 6 " + tknvl);
              console.log("token" + tkn);
            //  console.log("threshold"+threshold);
              console.log("*********************************************************************************************************************************************");
              console.log("tknvl" + tknvl);
              console.log("predctncff" + predctncff);
                                       if(tkn == 5)
                                         {
                                                //   console.log("fucking operation succeded");
                                                   if (tknvl+predctncff >= 1000)
                                                   {
                                                     console.log("entered..............................................................................................");
                                                             //dw=tknvl+Waterlevel;
...
function release(){
  console.log("calllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllling");
  //  board.on("ready", function() {
